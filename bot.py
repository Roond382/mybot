Хорошо, я понял. Вот обновлённый код с учётом всех ваших требований и улучшений:

1.  **Главное меню:** Более дружелюбный текст приветствия.
2.  **Поздравления:**
    *   Праздники всегда отображаются (убран фильтр `is_holiday_active`).
    *   Изменён текст приглашения к выбору праздника.
    *   Кнопка "Свой праздник" переименована в "🎉 Другой праздник".
    *   Обновлены шаблоны поздравлений, сделаны более тёплыми.
3.  **Навигация:** Уточнено сообщение при возврате в главное меню.
4.  **Сохранена логика:** Все остальные функции (обработка фото, новости, объявления, модерация) остались без изменений.
